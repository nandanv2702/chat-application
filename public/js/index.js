...
document.addEventListener('submit', (e) => {
  ...
  if (document.getElementById('text-msg').value !== '') {
    ...
    appendMessage({ name, msg: document.getElementById('text-msg').value }, 'right');
    updateHeight();
...
function sidebarswitch() {
  document.getElementById('sidebar-content-long').addEventListener('click', (e) => {
...
function updateHeight() {
  const messageBody = document.getElementById('chat-content');
  if (messageBody) {
